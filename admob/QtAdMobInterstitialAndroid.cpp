...
JNIEXPORT void JNICALL Java_org_ping_cool_QtAdMobActivity_onInterstitialLoaded(JNIEnv *env, jobject thiz)
{
    Q_UNUSED(env)
    Q_UNUSED(thiz)
...
JNIEXPORT void JNICALL Java_org_ping_cool_QtAdMobActivity_onInterstitialLoading(JNIEnv *env, jobject thiz)
{
    Q_UNUSED(env)
    Q_UNUSED(thiz)
...
JNIEXPORT void JNICALL Java_org_ping_cool_QtAdMobActivity_onInterstitialWillPresent(JNIEnv *env, jobject thiz)
{
    Q_UNUSED(env)
    Q_UNUSED(thiz)
...
JNIEXPORT void JNICALL Java_org_ping_cool_QtAdMobActivity_onInterstitialClicked(JNIEnv *env, jobject thiz)
{
    Q_UNUSED(env)
    Q_UNUSED(thiz)
...
JNIEXPORT void JNICALL Java_org_ping_cool_QtAdMobActivity_onInterstitialClosed(JNIEnv *env, jobject thiz)
{
    Q_UNUSED(env)
    Q_UNUSED(thiz)
