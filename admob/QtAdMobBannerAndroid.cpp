...
JNIEXPORT void JNICALL Java_org_ping_cool_QtAdMobActivity_onBannerLoaded(JNIEnv *env, jobject thiz)
{
    Q_UNUSED(env)
    Q_UNUSED(thiz)
...
JNIEXPORT void JNICALL Java_org_ping_cool_QtAdMobActivity_onBannerLoading(JNIEnv *env, jobject thiz)
{
    Q_UNUSED(env)
    Q_UNUSED(thiz)
...
JNIEXPORT void JNICALL Java_org_ping_cool_QtAdMobActivity_onBannerClosed(JNIEnv *env, jobject thiz)
{
    Q_UNUSED(env)
    Q_UNUSED(thiz)
...
JNIEXPORT void JNICALL Java_org_ping_cool_QtAdMobActivity_onBannerClicked(JNIEnv *env, jobject thiz)
{
    Q_UNUSED(env)
    Q_UNUSED(thiz)
